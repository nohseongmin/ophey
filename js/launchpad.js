...
const SOUNDS = [
  ...
  { id: 'eeeee', ko: '에에에에!', en: 'Eeeee!', emoji: '😱', clr: '#ff006e', file: 'audio/eeeee.mp3', accent: { freq: 900, type: 'sine', dur: 0.7 } },
  { id: 'horse', ko: '말 울음', en: 'Horse!', emoji: '🐴', clr: '#ffbe0b', file: 'audio/horse.mp3', accent: { freq: 180, type: 'sawtooth', dur: 0.5 } },
